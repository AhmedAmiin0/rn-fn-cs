    ...
    <SafeAreaView>
      ...
      >
        ...
        <View style={{ flexDirection: 'row', gap: 8, marginBottom: 24 }}>
          <StatisticsCard isPrimary
            title='10k'
            subtitle='limited edition Contracts'
          />
        ...
        <View style={{ flexDirection: 'row', gap: 8, marginBottom: 24, height: 91, flex: 1 }}>
          <Image source={require('../../assets/images/section.png')}
            resizeMode='contain'
        ...
        <View>
          ...
          >
            Activate and flaunt 'Bitcoin' name on your phone in under 5 mins
          </Paragraph>
        </View>
